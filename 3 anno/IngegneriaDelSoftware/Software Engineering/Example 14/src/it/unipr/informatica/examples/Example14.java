...
public class Example14 {
	...
	private void go() {
		...
		ActiveHandler<ActiveDownloadManager> downloadManagerHandler = ActiveAspect.attach(ActiveDownloadManager.class,
				downloadManager);
		...
		//Future<ResourceContent> futureError = activeDownloadManager.download("https://www.ebay1.it");
		...
		try {
			...
			//ResourceContent contentError = futureError.get();
			
			//process(contentError);
