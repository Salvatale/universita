...
/*
Il codice scritto così rispetta l'exception safety ma non è bellissimo dato che
ci sono più linee per gestire le risorse in caso di problemi che il codice normale,
risulta anche difficile distinguere questi due pezzi di codice.
Questo approccio risulta comunque essere corretto ma costa tanta fatica anche nel
leggerlo.
