...
int main(int argc, char **argv) {
    ...
    cout << "tree dimension: " << n_nodes + 1 << " and number of iteration: " << ct_it << endl;
    ...
    tree_insert_child_L(root7->L->L->L,12);
    tree_insert_child_L(root7->L->L->R,13);
    tree_insert_child_R(root7->L->L->R,14);
    tree_insert_child_L(root7->L->L->R->L,15);
    tree_insert_child_L(root7->L->L->R->R,16);
    tree_insert_child_R(root7->L->L->R->R,17);
    ...
    tree_insert_child_L(root8->R->R->L,12);
    tree_insert_child_R(root8->R->R->L,13);
    tree_insert_child_R(root8->R->R->R,14);
    tree_insert_child_L(root8->R->R->L->L,15);
    tree_insert_child_R(root8->R->R->L->L,16);
    tree_insert_child_R(root8->R->R->L->R,17);
