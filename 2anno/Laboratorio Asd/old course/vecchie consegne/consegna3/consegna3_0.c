...
void Heapsort() {
  ...
  for(int i = d; i > 0;--i){
    ...
    //cout << "valore estratto: " << min << "al punto:" << i << endl;
    cout << "posizione in cui inserisco " << min << "= " << heap_size << endl;
    heap[heap_size] = min;
  }
  heap_size = d; 
}
...
int main(int argc, char **argv) {
  ...
  */
  ...
  Heapsort();
  cout << "heap_size dopo Heapsort: " << heap_size << endl;
