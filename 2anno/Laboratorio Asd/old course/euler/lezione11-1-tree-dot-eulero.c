...
node_t* build_euler(int n1){
  ...
  n2 = dati[elem];
  ++elem;
  cout << "ricorsione nel nodo: " << node1->val << " ho preso n2= dati[" << elem-1 << "]= " << n2 << endl;
  //input_visit >> c;
  
  if (n1!=n2) {
    //cout << node1->val << " è entrato nel figlio sx: " << n2 << endl;
    node_t* node2 = build_euler(n2);
    //node1->L = new node_t;
    node1->L = node2;
    sx = 1;
  }
  ...
  n3 = dati[elem];
  ++elem;
  cout << "ricorsione nel nodo: " << node1->val << " ho preso n3= dati[" << elem-1 << "]= " << n3 << endl;
  //input_visit >> c;
  if(n3 == n1 && sx){
    n3 = dati[elem];
    ++elem;
    cout << "estraggo n3=dati[" << elem-1 << "]= " << n3 << " e finisce ricorsione del " << node1->val << endl;
    return node1;
  }

  if (n2!=n3){
    //cout << node1->val << " è entrato nel figlio dx: " << n3 << endl;
    node_t* node2 = build_euler(n3);
    //node1->R = new node_t;
    node1->R = node2;
    //input_visit >> n3;
  }
  //cout << node1->val << "finito" << endl;
  ...
  //cout << "fine ricorsione del nodo: " << node1->val << endl;
  return node1;
}
...
*/
  ...
  */
  ...
  //input_visit >> c;
  cout << dati[0] << endl;
  node_t* root=build_euler(dati[0]);
  global_ptr_ref=root;
  input_visit.close();
